...
class GameBar(pygame.Surface):
    ...
    def __init__(self, size, joueur):
        ...
        self.munition = pygame.image.load("images/logos/logo_munitions.png").convert_alpha()
        self.explosif = pygame.image.load("images/logos/logo_explosif.png").convert_alpha()
        self.bouclier = pygame.image.load("images/logos/logo_bouclier.png").convert_alpha()
        self.duplication = pygame.image.load("images/logos/logo_duplication.png").convert_alpha()
    ...
    def draw(self, surface, txt=""):
        ...
        if self.joueur.explosifs:
            ...
            x_droite -= nb_explosifs.get_width() + 70
        ...
        #affichage des informations sur les boucliers
        if self.joueur.boucliers:
            nb_boucliers = self.font_medium.render(str(self.joueur.boucliers), True, "WHITE")
            x_droite -= nb_boucliers.get_width() + 70
            surface.blit(nb_boucliers, (x_droite, self.get_height() // 2 - nb_boucliers.get_height() // 2))
            
            x_droite -= self.bouclier.get_width() + 20
            surface.blit(self.bouclier, (x_droite, self.get_height() // 2 - self.bouclier.get_height() // 2))
        ...
        if self.joueur.duplications:
            ...
            x_droite -= nb_duplications.get_width() + 70
